	...
	if( $_SESSION['email']=="" AND $_SESSION['level']=="" ){
		...
		require "../../../config/tgl_indo.php";
			...
			$query17  = $db->query("SELECT orders.id_orders,orders.tanggal,
						...
						WHERE orders.id_orders=orders_detail.id_orders AND produk.id_produk=orders_detail.id_produk AND
						orders.status_orders= 'Lunas' AND orders.tanggal = '$tanggal'");
			...
			if ($jml > 0){
				...
				echo 'Tidak ada transaksi pada tanggal '.$tanggal.'';
		}
	}
?>
