...
?>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<p class="pull-right">
					<button type="button" class="btn btn-info" data-toggle="tooltip" title="Tambah" onclick="window.location.href='?module=gambarproduk&act=tambahgambarproduk';"><i class="glyphicon glyphicon-plus"></i></button>
					...
					<button type="button" class="btn btn-default" data-toggle="tooltip" title="Refresh" onclick="window.location.href='?module=gambarproduk';"><i class="glyphicon glyphicon-refresh"></i></button>
					</p>
				</div>
			</div>
			<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					...
					<div class="table-responsive">	
						<table id="gambar" class="table table-bordered table-striped">
							<thead>
								<tr class="bg-warning">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<p class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="tooltip" title="Refresh" onclick="window.location.href='?module=gambarproduk&act=tambahgambarproduk';"><i class="fa fa-refresh"></i></button>
						<button type="button" class="btn btn-danger" data-toggle="tooltip" title="Kembali" onclick="window.location.href='?module=gambarproduk';"><i class="fa fa-share"></i></button>
					</p>
					...
					<?php						
						if ( isset($_POST['tambah']) ){
							...
							if ( empty($produk) ){
								...
								echo '</div>';
								echo "<meta http-equiv='refresh' content='1; url=?module=gambarproduk&act=tambahgambarproduk'>";
							}
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="produk" class="form-control" id="select5">
									<option value=""></option>
									<?php
										$query5       = $db->query("SELECT id_produk, nama_produk FROM produk ORDER BY nama_produk ASC");
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<p class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="tooltip" title="Refresh" onclick="window.location.href='?module=gambarproduk&act=ubahgambarproduk&id=<?php echo $_GET['id']; ?>&token=<?php echo $_GET['token']; ?>';"><i class="fa fa-refresh"></i></button>
						<button type="button" class="btn btn-danger" data-toggle="tooltip" title="Kembali" onclick="window.location.href='?module=gambarproduk';"><i class="fa fa-share"></i></button>
					</p>
					...
					<?php
						...
						if ( isset($_POST['ubah']) ){
							...
							if ( empty($produk) ){
								...
								echo '</div>';
								echo "<meta http-equiv='refresh' content='1; url=?module=gambarproduk&act=ubahgambarproduk&id=$_GET[id]&token=$_GET[token]'>";
							}
						}
