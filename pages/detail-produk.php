		...
		<div class="container">
			<div class="single-info">		
						...
						<ul class="slides">
							...
							<?php
								...
								while ( $row11 = $result11->fetch_assoc() ){
									echo '<li data-thumb="gambar/gambar_produk/'.$row11['gambar'].'">';
									echo '<div class="thumb-image"> <img src="gambar/gambar_produk/'.$row11['gambar'].'" data-imagezoom="true" class="img-responsive" alt=""> </div>';
									echo '</li>';
								}
							?>
						</ul>
				...
				<div class="col-md-6 single-top-left simpleCart_shelfItem wow fadeInRight animated" data-wow-delay=".5s">
					...
					<p style="font-size : 12px;"><i>Penjual : <?php echo $row10['nama_lengkap']; ?></i></p>
					
					<?php echo $harga_barang; ?>			
					<p><?php echo $isi; ?></p>
					<ul class="size">
						<h4>Kategori</h4>
						<li><a href="kategori-produk-<?php echo $row10['id_kategori']; ?>-<?php echo $row10['kategori_seo']; ?>.html"><?php echo $row10['nama_kategori']; ?></a><b>-></b><a href="kategori-<?php echo $row10['id_subkategori'] ?>-<?php echo $row10['subkategori_seo'] ?>.html"><?php echo $row10['nama_subkategori']; ?></a></li>
					</ul>
					<ul class="color">
						<h4>Berat</h4>
					...
					<form method="POST" action="aksi.php?module=keranjang&act=detailbeli&id=<?php echo $row10['id_produk']; ?>">
						<div class="quantity">
							<p class="qty"> Qty :  </p><input min="1" value="1" type="number" name="qty" class="item_quantity">
						</div>
						<div class="btn_form">
							<?php echo $tombol; ?>	
						</div>
			...
			<div class="related-products">
				<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
					<h3 class="title">Produk<span> Lainnya</span></h3>
				</div>
