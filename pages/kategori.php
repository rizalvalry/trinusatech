   ...
   <section class="elementor-section elementor-top-section elementor-element elementor-element-9b65b01 elementor-section-height-min-height elementor-section-boxed elementor-section-height-default elementor-section-items-middle" data-id="9b65b01" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
      <div class="elementor-container elementor-column-gap-wider">
         <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-93158fa" data-id="93158fa" data-element_type="column">
			...
			?>
			<div class="container-card wow fadeInRight animated">
				<div class="card" style="width: 18rem;">
					<img src="gambar/thumb_produk1/<?php echo $row5['gambar']; ?>" class="card-img-top" alt="...">
					<div class="card-body">
						<h5 class="card-title"><?php echo $row5['nama_produk']; ?></h5>
						<p class="card-text elementor-search-form__submit"><i aria-hidden="true" class="fa-solid fa-right-left"></i> Terkait</p>
                        
						<!-- <a href="#" class="btn btn-primary">Go somewhere</a> -->
						<a href="produk-<?php echo $row5['id_produk']; ?>-<?php echo $row5['produk_seo']; ?>.html" class="elementor-button-link elementor-button elementor-size-md" role="button">
...
<div data-elementor-type="wp-post" data-elementor-id="2462" class="elementor elementor-2462">
                        <section class="elementor-section elementor-top-section elementor-element elementor-element-689600b elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="689600b" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
							...
							<i aria-hidden="true" class="fas fa-chevron-right"></i>						</span>
                                                                            <span class="elementor-icon-list-text"><?= $row45['nama_subkategori']; ?></span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="elementor-element elementor-element-4453511 elementor-invisible elementor-widget elementor-widget-heading" data-id="4453511" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;fadeInRight&quot;,&quot;_animation_delay&quot;:600}"
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                <h1 class="elementor-heading-title elementor-size-default">Belum Ada</h1>
                                                            </div>
                                                        </div>
