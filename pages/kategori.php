	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Kategori : <?php echo $row55['nama_subkategori']; ?></li>
			</ol>
		</div>
	</div>
	<!--//breadcrumbs-->
		...
		<div class="container">
			...
			?>
				...
				<center>
					...
					<?php
						$query27      = $db->query("SELECT id_produk FROM produk,subkategori_produk,kategori_produk WHERE produk.id_subkategori=subkategori_produk.id_subkategori AND subkategori_produk.id_kategori=kategori_produk.id_kategori AND subkategori_produk.id_subkategori='$_GET[id]'");
						$row27        = $query27->num_rows;
						$jumlah_hal27 = ceil ($row27/$batas);
					?>
						<li class="<?php if ( $_GET['halkategori'] <= 1 ) echo "disabled"; ?>"><a href="halkategori-<?php echo $_GET['id']; ?>-<?php echo $_GET['halkategori'] - 1; ?>.html"><i class="fa fa-angle-left">«</i></a></li>
						<?php
							for ( $i = 1; $i <= $jumlah_hal27; $i++ ){
						?>
							<li class="<?php if ( $_GET['halkategori'] == $i ) echo "active"; ?>"><a href="halkategori-<?php echo $_GET['id'].'-'. $i; ?>.html"><?php echo $i; ?></a></li>
						<?php
							}
						?>
						<li class="<?php if ( $_GET['halkategori'] >= $jumlah_hal27 ) echo "disabled"; ?>"><a href="halkategori-<?php echo $_GET['id']; ?>-<?php echo $_GET['halkategori'] + 1; ?>.html"><i class="fa fa-angle-right">»</i></a></li>
					</ul>
				</center>
				</div>
			</div>
