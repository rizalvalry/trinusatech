                                                ...
                                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-4b0f8b6" data-id="4b0f8b6" data-element_type="column">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        ...
                                                        <div class="elementor-element elementor-element-5c28b0a elementor-widget elementor-widget-heading" data-id="5c28b0a" data-element_type="widget" data-widget_type="heading.default">
                                                            <div class="elementor-widget-container">
                                                                <h2 class="elementor-heading-title elementor-size-default">Kami Telah Meluangkan Waktu Untuk Menyingkat Nilai Kami Menjadi Tujuh Poin Utama</h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-c0400a1" data-id="c0400a1" data-element_type="column">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        <div class="elementor-element elementor-element-6e7fba3 elementor-widget elementor-widget-text-editor" data-id="6e7fba3" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div class="elementor-widget-container">
                                                                <p>Saat kami tumbuh dan berkembang, kami berharap nilai-nilai ini berkembang bersama kami. Kami menggunakan inisiatif internal, seperti sesi Ask Me Anything dengan tim inti, untuk menjaga nilai-nilai kami tetap hidup.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="elementor-container elementor-column-gap-wider">
                                                <div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-c5ef89c" data-id="c5ef89c" data-element_type="column">
                                                    <div class="elementor-widget-wrap elementor-element-populated">
                                                        ...
                                                        <iframe width="560" height="315" src="https://www.youtube.com/embed/J6i53rCB0y8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
